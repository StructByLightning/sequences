...
export default function WhenAnthropomorphismBecameStupid() {
  return <Chapter title={["When Anthropomorphism", "Became Stupid"]}>


    <p><span className="dropCap">I</span>t turns out that most things in the universe don’t have minds. This statement would have provoked incredulity among many earlier cultures. “Animism” is the usual term. They thought that trees, rocks, streams, and hills all had spirits because, hey, why not?</p>
    ...
    <p>There is no obvious reason—no reason obvious <em>to a hunter-gatherer</em>—why this cannot be so. It only seems like a <em>stupid</em> mistake if you confuse weirdness with stupidity. Naturally the belief that rivers have animating spirits seems “weird” to us, since it is not a belief of our tribe. But there is nothing obviously stupid about thinking that great lumps of moving water have spirits, just like our own lumps of moving flesh.</p>
    ...
    <p>Alcmaeon of Croton, a Pythagorean of the fifth century BCE, put his finger on the brain as the seat of intelligence, because he’d traced the optic nerve from the eye to the brain. Still, with the amount of evidence he had, it was only a guess.</p>
    <p>When did the central role of the brain stop being a guess? I do not know enough history to answer this question, and probably there wasn’t any sharp dividing line. Maybe we could put it at the point where someone traced the anatomy of the nerves, and discovered that severing a nervous connection to <em>the brain</em> blocked movement and sensation?</p>
    <p>Even so, that is only a mysterious spirit moving through the nerves. Who’s to say that wood and water, even if they lack the little threads found in human anatomy, might not carry the same mysterious spirit by different means?</p>
    ...
    <p>But the discovery of that tangledness, and Charles Darwin’s theory of natural selection, and the notion of cognition as computation, is where I would put the gradual beginning of anthropomorphism’s descent into being <em>obviously</em> wrong.</p>
    ...
    <p>It’s the point where you can look at a river, and say, “Water doesn’t contain patterns replicating with distant heredity and substantial variation subject to iterative selection, so how would a river come to have any pattern so complex and functionally optimized as a brain?”</p>
    <p>It’s the point where you can look at an atom, and say: “Anger may look simple, but it’s not, and there’s no room for it to fit in something as simple as an atom—not unless there are whole universes of subparticles inside quarks; and even then, since we’ve never seen any sign of atomic anger, it wouldn’t have any effect on the high-level phenomena we know.”</p>
