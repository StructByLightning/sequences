...
export default function IsThatYourTrueRejection() {
  return <Chapter title={["Is That Your", "True Rejection?"]}>

    <p><span className="dropCap">I</span>t happens every now and then, that the one encounters some of my transhumanist-side beliefs—as opposed to my ideas having to do with human rationality—strange, exotic-sounding ideas like superintelligence and Friendly AI. And the one rejects them.</p>
    ...
    <p>There’s many reasons why someone <em>actually</em> has an adverse reaction to transhumanist theses. Most are matters of pattern recognition, rather than verbal thought: the thesis matches against “strange weird idea” or “science fiction” or “end-of-the-world cult” or “overenthusiastic youth.”</p>
    <p>So immediately, at the speed of perception, the idea is rejected. If, afterward, someone says “Why not?,” this launches a search for justification. But this search will not necessarily hit on the true reason—by “true reason” I mean not the best reason that could be offered, but rather, whichever causes were decisive as a matter of historical fact, at the <em>very first</em> moment the rejection occurred.</p>
    <p>Instead, the search for justification hits on the justifying-sounding fact, “This speaker does not have a PhD.”</p>
    <p>But I also don’t have a PhD when I talk about human rationality, so why is the same objection not raised there?</p>
    ...
    <ul>
      ...
      <li>Hard-to-verbalize intuitions, perhaps stemming from specific visualiza­tions;</li>
      ...
      <li>Emotional commitments to believingin a particular outcome;</li>
