...
export default function EntangledTruthsContagiousLies() {
  return <Chapter title={["Entangled Truths,", "Contagious Lies"]}>
    ...
    <blockquote>
      ...
      <p>—<em>First Lensman</em> <span class="footnote">Edward Elmer Smith and A. J. Donnell, <em>First Lensman</em> (Old Earth Books, 1997).</span></p>
    </blockquote>
    <blockquote>
