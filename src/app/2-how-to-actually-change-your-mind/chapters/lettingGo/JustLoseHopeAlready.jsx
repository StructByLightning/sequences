...
export default function JustLoseHopeAlready() {
  return <Chapter title={["Just Lose Hope Already"]}>
    ...
    <p>… namely Merton and Scholes of Long-Term Capital Management.</p>
