...
export default function TolerateTolerance() {
  return <Chapter title={["Tolerate Tolerance"]}>
    ...
    <p>Oh, and it goes without saying that if the people of Group <em>X</em> are staring at you demandingly, waiting for you to hate the right enemies with the right intensity, and ready to castigate you if you fail to castigate loudly enough, you may be hanging around the wrong group.</p>
    <p>Just don’t demand that <em>everyone</em> you work with be equally intolerant of behavior like that. Forgive your friends if some of them suggest that maybe Group <em>X</em> wasn’t so awful after all…</p>
