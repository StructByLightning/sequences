...
export default function MysteriousAnswersToMysteriousQuestions() {


  return <Chapter title={["Mysterious Answers to", "Mysterious Questions"]}>
    <p><span className="dropCap">I</span>magine looking at your hand, and knowing nothing of cells, nothing of biochemistry, nothing of DNA. You’ve learned some anatomy from dissection, so you know your hand contains muscles; but you don’t know why muscles move instead of lying there like clay. Your hand is just… stuff… and for some reason it moves under your direction. Is this not magic?</p>
    <blockquote>
      ...
      <p>—Lord Kelvin<span className="footnote">Silvanus Phillips Thompson, <em>The Life of Lord Kelvin</em> (American Mathematical Society, 2005).</span></p>
    </blockquote>
    <p>This was the theory of <em>vitalism</em>; that the mysterious difference between living matter and non-living matter was explained by an <em>élan vital</em> or <em>vis vitalis</em>. <em>Élan vital</em> infused living matter and caused it to move as consciously directed. <em>Élan vital</em> participated in chemical transformations which no mere non-living particles could undergo—Wöhler’s later synthesis of urea, a component of urine, was a major blow to the vitalistic theory because it showed that mere chemistry could duplicate a product of biology.</p>
    <p>Calling “élan vital” an explanation, even a fake explanation like phlogiston, is probably giving it too much credit. It functioned primarily as a curiosity-stopper. You said “Why?” and the answer was “Élan vital!”</p>
    <p>When you say “Élan vital!,” it <em>feels</em> like you know why your hand moves. You have a little causal diagram in your head that says:</p>


    <figure>
      <img src="/MysteriousAnswersToMysteriousQuestions_diagram_1.svg" alt="" />
    </figure>

    <p>But actually you know nothing you didn’t know before. You don’t know, say, whether your hand will generate heat or absorb heat, unless you have observed the fact already; if not, you won’t be able to predict it in advance. Your curiosity feels sated, but it hasn’t been fed. Since you can say “Why? Élan vital!” to any possible observation, it is equally good at explaining all outcomes, a disguised hypothesis of maximum entropy, et cetera.</p>
    <p>But the greater lesson lies in the vitalists’ reverence for the <em>élan vital</em>, their eagerness to pronounce it a mystery beyond all science. Meeting the great dragon Unknown, the vitalists did not draw their swords to do battle, but bowed their necks in submission. They took pride in their ignorance, made biology into a <em>sacred</em> mystery, and thereby became loath to relinquish their ignorance when evidence came knocking.</p>
    <p>The Secret of Life was <em>infinitely beyond the reach of science!</em> Not just a <em>little</em> beyond, mind you, but <em>infinitely</em> beyond! Lord Kelvin sure did get a tremendous emotional kick out of <em>not knowing something</em>.</p>
    ...
    <p>Therefore I call theories such as vitalism <em>mysterious answers to mysterious questions</em>.</p>
    <p>These are the signs of mysterious answers to mysterious questions:</p>
    <ul>
      <li>First, the explanation acts as a curiosity-stopper rather than an anticipation-controller.</li>
      <li>Second, the hypothesis has no moving parts—the model is not a specific complex mechanism, but a blankly solid substance or force. The mysterious substance or mysterious force may be said to be here or there, to cause this or that; but the reason why the mysterious force behaves thus is wrapped in a blank unity.</li>
      <li>Third, those who proffer the explanation cherish their ignorance; they speak proudly of how the phenomenon defeats ordinary science or is unlike merely mundane phenomena.</li>
