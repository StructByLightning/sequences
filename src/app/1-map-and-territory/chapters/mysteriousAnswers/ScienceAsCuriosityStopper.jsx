...
export default function ScienceAsCuriosityStopper() {


  return <Chapter title={["“Science” as Curiosity-Stopper"]}>
    <p><span className="dropCap">I</span>magine that I, in full view of live television cameras, raised my hands and chanted <em>abracadabra</em> and caused a brilliant light to be born, flaring in empty space beyond my outstretched hands. Imagine that I committed this act of blatant, unmistakeable sorcery under the full supervision of James Randi and all skeptical armies. Most people, I think, would be <em>fairly curious</em> as to what was going on.</p>
    <p>But now suppose instead that I don’t go on television. I do not wish to share the power, nor the truth behind it. I want to keep my sorcery secret. And yet I also want to cast my spells whenever and wherever I please. I want to cast my brilliant flare of light so that I can read a book on the train—without anyone becoming curious. Is there a spell that stops curiosity?</p>
    <p>Yes indeed! Whenever anyone asks “How did you do that?,” I just say “Science!”</p>
    <p>It’s not a real explanation. It doesn’t tell you whether the light will brighten or fade, change color in hue or saturation, and it certainly doesn’t tell you how to make a similar light yourself. You don’t actually <em>know</em> anything more than you knew before I said the magic word. But you turn away, satisfied that nothing unusual is going on.</p>
    <p>Better yet, the same trick works with a standard light switch.</p>
    <p>Flip a switch and a light bulb turns on. Why?</p>
    <p>In school, one is taught that the password to the light bulb is “Electricity!”</p>
    <p>By now, I hope, you’re wary of marking the light bulb “understood” on such a basis. Does saying “Electricity!” let you do calculations that will control your anticipation of experience? There is, at the least, a great deal more to learn. (Physicists should ignore this paragraph and substitute a problem in evolutionary theory, where the substance of the theory is again in calculations that few people know how to perform.)</p>
    ...
    <p>Someone is bound to say, “If the light bulb were unknown to science, you could gain fame and fortune by investigating it.” But I’m not talking about greed. I’m not talking about career ambition. I’m talking about the raw emotion of curiosity—the feeling of being intrigued. Why should <em>your</em> curiosity be diminished because someone <em>else</em>, not you, knows how the light bulb works? Is this not spite? It’s not enough for <em>you</em> to know; other people must also be ignorant, or you won’t be happy?</p>
    ...
    <p>And a voice comes from above the elephant, saying,</p>
    <p style={{ fontFamily: "var(--secondaryFont)", textAlign: "center" }}>Somebody already knows why this elephant is here.</p>
