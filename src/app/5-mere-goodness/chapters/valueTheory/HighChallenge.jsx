...
export default function HighChallenge() {
  return <Chapter title={["High Challenge"]}>



    <p><span className="dropCap">T</span>here’s a class of prophecy that runs: “In the Future, machines will do all the work. Everything will be automated. Even labor of the sort we now consider ‘intellectual,’ like engineering, will be done by machines. We can sit back and own the capital. You’ll never have to lift a finger, ever again.”</p>
    <p>But then won’t people be bored?</p>
    <p>No; they can play computer games—not like <em>our</em> games, of course, but much more advanced and entertaining.</p>
    <p>Yet wait! If you buy a modern computer game, you’ll find that it contains some tasks that are—there’s no kind word for this—<em>effortful</em>. (I would even say “difficult,” with the understanding that we’re talking about something that takes ten minutes, not ten years.)</p>
    <p>So in the future, we’ll have programs that <em>help</em> you play the game—taking over if you get stuck on the game, or just bored; or so that you can play games that would otherwise be too advanced for you.</p>
    ...
    <p>So this is the ultimate end of the prophecy of technological progress—just staring at a screen that says “You Win,” forever.</p>
    ...
    <p>Or to phrase that somewhat less paradoxically: We should look for valuations that are over 4D states, rather than 3D states. Valuable ongoing processes, rather than “make the universe have property <em>P</em> and then you’re done.”</p>
    <p>Timothy Ferris is worth quoting: To find happiness, “the question you should be asking isn’t ‘What do I want?’ or ‘What are my goals?’ but ‘What would excite me?’ ”</p>
    <p>You might say that for a long-run meaning of life, we need games that are fun to <em>play</em> and not just to <em>win</em>.</p>
    <p>Mind you—sometimes you <em>do</em> want to win. There are legitimate goals where winning is everything. If you’re talking, say, about curing cancer, then the suffering experienced by even a single cancer patient outweighs any fun that you might have in solving their problems. If you work at creating a cancer cure for twenty years through your own efforts, learning new knowledge and new skill, making friends and allies—and then some alien superintelligence offers you a cancer cure on a silver platter for thirty bucks—then you shut up and take it.</p>
    ...
    <p>Why should this “valuable ongoing process” be a process of <em>trying to do things</em>—why not a process of passive experiencing, like the Buddhist Heaven?</p>
    ...
    <p>I’m not going to touch that one. I’ll stick with the much simpler answer of “I wouldn’t actually <em>prefer</em> to be a passive experiencer.” If I <em>wanted</em> Nirvana, I might try to figure out how to achieve that impossibility. But once you strip away Buddha telling me that Nirvana is the end-all of existence, Nirvana seems rather more like “sounds like good news in the moment of first being told” or “ideological belief in desire,” rather than, y’know, something I’d actually <em>want</em>.</p>
    <p>The reason I have a mind at all is that natural selection built me to <em>do</em> things—to solve certain kinds of problems.</p>
    <p>“Because it’s human nature” is not an explicit justification for anything. There is human nature, which is what we are; and there is humane nature, which is what, being human, we wish we were.</p>
    <p>But I don’t <em>want</em> to change my nature toward a more passive object—which <em>is</em> a justification. A happy blob is <em>not</em> what, being human, I wish to become.</p>
    <p>I earlier argued that many values require both subjective happiness and the external objects of that happiness. That you can legitimately have a utility function that says, “It matters to me whether or not the person I love is a real human being or just a highly realistic nonsentient chatbot, <em>even if I don’t know</em>, because that-which-I-value is not my own state of mind, but the external reality.” So that you need both the experience of love, and the real lover.</p>
    <p>You can similarly have valuable activities that require both real challenge and real effort.</p>
    <p>Racing along a track, it matters that the other racers are real, and that you have a real chance to win or lose. (We’re not talking about physical determinism here, but whether some external optimization process explicitly chose for you to win the race.)</p>
    ...
    <p>There must be the true effort, the true victory, and the true experience—the journey, the destination and the traveler.</p>
  </Chapter>;
}