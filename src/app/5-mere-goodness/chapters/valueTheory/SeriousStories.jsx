...
export default function SeriousStories() {
  return <Chapter title={["Serious Stories"]}>



    <p><span className="dropCap">E</span>very Utopia ever constructed—in philosophy, fiction, or religion—has been, to one degree or another, a place where you wouldn’t <em>actually want</em> to live. I am not alone in this important observation: George Orwell said much the same thing in “Why Socialists Don’t Believe In Fun,” and I expect that many others said it earlier.</p>
    ...
    <p>In the age of my youthful folly, I took for granted that <em>authors</em> were excused from the search for true Eutopia, because if you constructed a Utopia that <em>wasn’t</em> flawed… what stories could you write, set there? “Once upon a time they lived happily ever after.” What use would it be for a science-fiction author to try to depict a positive intelligence explosion, when a positive intelligence explosion would be…</p>
    ...
    <p>So I swallowed my trained-in revulsion of Luddism and theodicy, and at least <em>tried</em> to contemplate the argument:</p>
    <ul>
    ...
    <p>You simply don’t optimize a story the way you optimize a real life. The best story and the best life will be produced by different criteria.</p>
    ...
    <p>One answer might be that what a story really needs is not “disaster,” or “pain,” or even “conflict,” but simply <em>striving</em>. That the problem with Mary Sue stories is that there’s not enough striving in them, but they wouldn’t actually need <em>pain</em>. This might, perhaps, be tested.</p>
    ...
    <p>Investigating the life of the priest and proto-rationalist Friedrich Spee von Langenfeld, who heard the confessions of accused witches, I looked up some of the instruments that had been used to produce confessions. There is no ordinary way to make a human being feel as <em>good</em> as those instruments would make you hurt. I’m not sure even drugs would do it, though my experience of drugs is as nonexistent as my experience of torture.</p>
    ...
    <p>If only people were constructed differently, so that you could produce pleasure as intense and in as many different flavors as pain! If only you could, with the same ingenuity and effort as a torturer of the Inquisition, make someone feel as <em>good</em> as the Inquisition’s victims felt <em>bad</em>—</p>
    ...
    <p>Humans, built the way we are now, do seem to have hedonic scaling tendencies. Someone who can remember starving will appreciate a loaf of bread more than someone who’s never known anything but cake. This was George Orwell’s hypothesis for why Utopia is impossible in literature and reality:<span class="footnote">George Orwell, “Why Socialists Don’t Believe in Fun,” Tribune (December 1943).</span></p>
    <blockquote>
      <p>It would seem that human beings are not able to describe, nor perhaps to imagine, happiness except in terms of contrast… The inability of mankind to imagine happiness except in the form of relief, either from effort or pain, presents Socialists with a serious problem. Dickens can describe a poverty-stricken family tucking into a roast goose, and can make them appear happy; on the other hand, the inhabitants of perfect universes seem to have no spontaneous gaiety and are usually somewhat repulsive into the bargain.</p>
    </blockquote>
    ...
    <p>But that does not show there’s no alternative which could serve the same purpose. Could you delete pain and replace it <em>with an urge not to do certain things</em> that lacked the intolerable subjective quality of pain? I do not know all the Law that governs here, but I’d have to guess that yes, you could; you could replace that side of yourself with something more akin to an expected utility maximizer.</p>
    ...
    <p>So far as I know or can guess, David Pearce (<em>The Hedonistic Imperative</em>) is very probably right about the <em>feasibility</em> part, when he says:<span class="footnote">David Pearce, The Hedonistic Imperative, http://www.hedweb.com/, 1995.</span></p>
    <blockquote>
      <p>Nanotechnology and genetic engineering will abolish suffering in all sentient life. The abolitionist project is hugely ambitious but technically feasible. It is also instrumentally rational and morally urgent. The metabolic pathways of pain and malaise evolved because they served the fitness of our genes in the ancestral environment. They will be replaced by a different sort of neural architecture—a motivational system based on heritable gradients of bliss. States of sublime well-being are destined to become the genetically pre-programmed norm of mental health. It is predicted that the world’s last unpleasant experience will be a precisely dateable event.</p>
    </blockquote>
    ...
    <p>To leave things as they are? Of course not. No God designed this world; we have no reason to think it exactly optimal on any dimension. If this world does not contain too much pain, then it must not contain enough, and the latter seems unlikely.</p>
    <p>But perhaps…</p>
    ...
    <p>So that would be one alternative to Pearce’s world—if there are yet other alternatives, I haven’t thought them through in any detail.</p>
