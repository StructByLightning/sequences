...
export default function EndsDontJustifyMeansAmongHumans() {
  return <Chapter title={["Ends Don't Justify", "Means (Among Humans)"]}>



    <blockquote>
      <p>If the ends don’t justify the means, what does?</p>
      <p>—variously attributed</p>
    </blockquote>
    <blockquote>
      <p>I think of myself as running on hostile hardware.</p>
      <p>—Justin Corwin</p>
    </blockquote>
    <p><span className="dropCap">H</span>umans may have evolved a structure of political revolution, beginning by believing themselves morally superior to the corrupt current power structure, but ending by being corrupted by power themselves—not by any plan in their own minds, but by the echo of ancestors who did the same and thereby reproduced.</p>
    <p>This fits the template:</p>
    <blockquote>
      <p>In some cases, human beings have evolved in such fashion as to think that they are doing <em>X</em> for prosocial reason <em>Y</em>, but when human beings actually do <em>X</em>, other adaptations execute to promote self-benefiting consequence <em>Z</em>.</p>
    </blockquote>
    <p>From this proposition, I now move on to a question <em>considerably</em> outside the realm of classical Bayesian decision theory:</p>
    <blockquote>
      <p>What if I’m running on corrupted hardware?</p>
    </blockquote>
    <p>In such a case as this, you might even find yourself uttering such seemingly paradoxical statements—sheer nonsense from the perspective of classical decision theory—as:</p>
    <blockquote>
      <p>The ends don’t justify the means.</p>
    </blockquote>
    <p>But if you are running on corrupted hardware, then the reflective observation that it <em>seems</em> like a righteous and altruistic act to seize power for yourself—this <em>seeming</em> may not be much evidence for the proposition that seizing power is in fact the action that will most benefit the tribe.</p>
    <p>By the power of naive realism, the corrupted hardware that you run on, and the corrupted seemings that it computes, will seem like the fabric of the very world itself—simply the way-things-are.</p>
    ...
    <p>Indeed it may be wiser to phrase it this way. If you just say, “when it <em>seems</em> like it would provide a net benefit to the tribe,” then you get people who say, “But it doesn’t just <em>seem</em> that way—it <em>would</em> provide a net benefit to the tribe if I were in charge.”</p>
    ...
    <p>And now the philosopher comes and presents their “thought experiment”— setting up a scenario in which, <em>by stipulation</em>, the <em>only</em> possible way to save five innocent lives is to murder one innocent person, and this murder is <em>certain</em> to save the five lives. “There’s a train heading to run over five innocent people, who you can’t possibly warn to jump out of the way, but you can push one innocent person into the path of the train, which will stop the train. These are your only options; what do you do?”</p>
    <p>An altruistic human, who has accepted certain deontological prohibitions— which seem well justified by some historical statistics on the results of reasoning in certain ways on untrustworthy hardware—may experience some mental distress, on encountering this thought experiment.</p>
    ...
    <p>Now, to me this seems like a dodge. I think the universe is sufficiently unkind that we can justly be forced to consider situations of this sort. The sort of person who goes around proposing that sort of thought experiment might well deserve that sort of answer. But any human legal system does embody some answer to the question “How many innocent people can we put in jail to get the guilty ones?,” even if the number isn’t written down.</p>
